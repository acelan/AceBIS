...
def build_list():
    ...
    def is_valid_for_class_spec(cclass, spec, itemclass, itemtype, itemsubclass, item):
        ...
        if cclass == "DK":
            ...
            if itemclass == "Armor":
                if itemsubclass != "Plate" and itemtype not in ["Back", "Finger", "Neck", "Trinket"]:
                    return False
            elif itemclass == "Weapon":
                if itemtype == "Ranged" and itemsubclass != "Relic":
                    return False
                if itemsubclass in ["Shield", "Staff", "Fist"]:
                    return False
        elif cclass == "Druid":
            ...
            if itemclass == "Armor":
                if itemsubclass != "Leather" and itemtype not in ["Back", "Finger", "Neck", "Trinket"]:
                    return False
            elif itemclass == "Weapon":
                if itemtype == "Ranged" and itemsubclass != "Relic":
                    return False
            ...
            if itemclass == "Armor":
                if itemsubclass != "Mail" and itemtype not in ["Back", "Finger", "Neck", "Trinket"]:
                    return False
            ...
            if itemclass == "Armor":
                if itemsubclass != "Cloth" and itemtype not in ["Back", "Finger", "Neck", "Trinket"]:
                    return False
                if itemsubclass == "Relic":
                    return False
            elif itemclass == "Weapon":
            ...
            if itemclass == "Armor":
                ...
                if spec == "Protection" and "dodgertng" not in item and "parryrtng" not in item and "blockrtng" not in item:
                    if itemtype not in ["Amulet", "Trinket", "Ranged"]:
                        return False
            elif itemclass == "Weapon":
                if itemtype == "Ranged" and itemsubclass != "Relic":
                    return False
